...
public class CustomTableDumpVisitor extends DumpSymbolTableVisitor {
	Struct parentType = null;
	@Override
	...
	public void visitObjNode(Obj objToVisit) {
		...
		if ((Obj.Var == objToVisit.getKind()) && "this".equalsIgnoreCase(objToVisit.getName()) || 
				parentType != null && objToVisit.getType().equals(parentType))
			output.append("");
		else
